...
class MPU6050 {
    public:
        ...
        void getAverageData(int *mean_ax, int *mean_ay, int *mean_az, int *mean_gx, int *mean_gy, int *mean_gz, int count);
        void Calibration(int count = 1000, int acel_deadzone = 8, int giro_deadzone = 1);
