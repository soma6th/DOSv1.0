...
public class OrientationProvider implements SensorEventListener {
    ...
    private OrientationProvider() {
        this.displayOrientation = LevelActivity.getContext().getWindowManager().getDefaultDisplay().getRotation();
    }
    ...
    public void startListening(OrientationListener orientationListener) {
        final Activity context = LevelActivity.getContext();
        // load calibration
        calibrating = false;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (calibrating) {
            calibrating = false;
            SharedPreferences.Editor editor = LevelActivity.getContext().getPreferences(Context.MODE_PRIVATE).edit();
    ...
    public final void resetCalibration() {
        ...
        try {
            success = LevelActivity.getContext().getPreferences(
